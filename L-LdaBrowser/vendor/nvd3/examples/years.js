      ...
      .on("click",function(d){
        ...
        d3.json("data/yearstwords.json",function(d2){
          ...
          for (var i = 0 ; i < 5 ; i ++){
            ...
            var svg = "<svg><g><rect x=\"0\" y=\"16\" width=\""+(parseFloat(wordData[i].probs)*100).toFixed(2)+"\" height=\"13\" fill=\"#03a9f4\"></rect><text x=\"105\" y=\"27\" font-family=\"Verdana\" font-size=\"14px\"> "+(parseFloat(wordData[i].probs)*100)+"% </text></g></svg>";
            document.getElementById("pt"+(i+1)).innerHTML = svg;
          }
