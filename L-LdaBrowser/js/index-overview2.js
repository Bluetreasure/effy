LDAvis = function(to_select, json_file) {
    ...
    color1 = "#00963d", // baseline color for default topic circles and overall term frequencies
    color2 = "#00e394"; // 'highlight' color for selected topics and term-topic frequencies
    ...
    barwidth = 300,
    barheight = 300,
    termwidth = 10, // width to add between two panels to display terms
...
if (topic_num == 1) {return title_name[0]} else{return title_name[topic_num-1][0]};
        ...
        var y = d3.scale.ordinal()
            ...
            .rangeRoundBands([100, barheight+300], 0.15);
	...
	// footnotes:
        ...
        basebars
            ...
            .style("text-anchor", "middle") // right align text - use 'middle' for center alignment
            .text(function(d) {
                return d.Term;
            })
            .on("click",function(d){window.open("http://52.198.131.106:8080/%E8%94%A1%E8%80%81%E5%B8%AB/%E8%87%AA%E7%94%B1%E4%B8%AD%E5%9C%8B/search?q="+d.Term,'_blank')})
