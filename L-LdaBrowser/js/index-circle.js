LDAvis = function(to_select, json_file) {
    ...
    var K, // number of topics 
        ...
        color1 = "#ffff3b", // baseline color for default topic circles and overall term frequencies
        color2 = "#ffbf00"; // 'highlight' color for selected topics and term-topic frequencies
    ...
    d3.json(json_file, function(error, data) {
        ...
        // http://www.nytimes.com/interactive/2012/02/13/us/politics/2013-budget-proposal-graphic.html?_r=04
        // 圓圈大小的標準
